...
public class MainActivity extends ListActivity {
    ...
    String[] things={"Аргентина","Куба","Чили","Уругвай","Колумбия","Я"};
    @Override
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                switch (position) {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        Intent intent5 = new Intent(MainActivity.this, Im.class);
                        startActivity(intent5);
                        break;
                    case 5:
                        Intent intent6 = new Intent(MainActivity.this, Uruguay.class);
